...
# 指向**最近**的那一个而不是最老的：上一版真正在 CDN 上服役过的根
# 是最现实的回放样本。更早的那些仍留在仓里。
OLDER_FIXTURE = ROOT / "tests/fixtures/update-manifest-v1.3.41.json"
...
CURRENT_PROMOTED_FIXTURE = (
    ROOT / "tests/fixtures/update-manifest-v1.3.24.json"
)
